...
@customElement('wcm-network-waiting')
export class W3mNetworkWaiting extends LitElement {
  ...
  private svgLoaderTemplate() {
    return html`
      <svg width="54" height="59" viewBox="0 0 54 59" fill="none" class="wcm-loader">
        <path
          id="wcm-loader-path"
        ...
        />
        <use xlink:href="#wcm-loader-path" stroke-dasharray="54 118" stroke-dashoffset="172"></use>
      </svg>
    `
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'wcm-network-waiting': W3mNetworkWaiting
  }
}
